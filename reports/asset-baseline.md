...
| 指标 | 大小 | 占项目源文件 | 说明 |
|---|---:|---:|---|
| 首屏可见资源 | 22.8 MB | 45.3% | Home 必须显示的代码和 Scene 1 素材 |
| 首屏驻留预加载 | 27.3 MB | 54.4% | 停留 Home 时准备的 Scene 2–4 图片和视频 |
| Scene 1 | 22.3 MB | 44.4% | 按路径归属的全部资源 |
...
| Scene 6 | 1.49 KB | 0.0% | 按路径归属的全部资源 |
| Scene 7 | 1.40 KB | 0.0% | 按路径归属的全部资源 |
| **全部源文件** | **50.3 MB** | **100.0%** | 排除 node_modules、dist、报告和临时目录 |
...
pie showData
    ...
    "首屏可见 (22.8 MB)" : 23859145
    "驻留预加载 (27.3 MB)" : 28661636
    "其他资源 (200.0 KB)" : 204821
```
...
| `scenes/scene-2/assets/scene2-glasses.mp4` | Video | 7.46 MB | 14.8% |
