(() => {
  ...
  R.register({
    ...
    layers: {
      ...
      scene1Background: image('Main background', 'main-background', 'scenes/scene-1/assets/scene1-landscape-4k.webp', 1536, 864, -296, 0, 1.298611, 0, 1),
      backgroundPerspective: image('Background perspective', 'background-perspective', 'scenes/scene-1/assets/Background%20perspective-2.webp', 1536, 864, -64, 168, 1.0, 4, 1),
      rock: image('Rock', 'rock', 'scenes/scene-1/assets/rock.png', 1536, 1024, 322, 804, 0.71, 40),
      characterMain: image('Character body', 'character-main', 'scenes/scene-1/assets/character-main.webp', 941, 1672, 598, 214, 0.448, 50, 1),
      characterPerspective: image('Character perspective overlay', 'character-perspective', 'scenes/scene-1/assets/Character%20perspective%20overlay-2.webp', 1024, 1536, 590, 198, 0.47, 52, 0.9),
